...
function GoogleLogin({ label }) {
  ...
  return (
    <button
      onClick={handleLogin}
      className="hover:bg-cream-bg bg-cream-bg flex w-full items-center justify-center gap-4 rounded-full border border-gray-300 py-4 shadow-md transition-colors md:bg-transparent"
    >
      <svg
